...
export default async function Index() {
  ...
  /* const navItems = [
    ...
    { name: "About", link: "/about", icon: <VideoCameraOutlined /> },
    { name: "Services", link: "/services", icon: <UploadOutlined /> },
    { name: "Contact", link: "/contact", icon: <UserOutlined /> },
  ]; */
  return (
    <>
